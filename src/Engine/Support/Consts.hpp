...
// inline constexpr float PAWN_STRUCTURE_SCORE_MULTIPLIER = 0.022f;

// inline constexpr float KING_SAFETY_SCORE_MULTIPLIER = 0.018f;

// inline constexpr float PST_SCORE_MULTIPLIER = 0.022f;

// inline constexpr float MOBILITY_SCORE_MULTIPLIER = 0.022f;

// inline constexpr float DEVELOPMENT_SCORE_MULTIPLIER = 0.015f;

// inline constexpr float ACTIVE_PIECE_MULTIPLIER = 0.025f;

// inline constexpr float SPACE_ADVANTAGE_MULTIPLIER = 0.025f;

// inline constexpr float SIMPLIFICATION_BONUS_MULTIPLIER = 0.01f;

// Learned values

// inline constexpr float DOUBLED_PAWNS_SCORE_MULTIPLIER = 0.00891602f;
// inline constexpr float ISOLATED_PAWNS_SCORE_MULTIPLIER = 0.00891602f;
// inline constexpr float SEMI_ISOLATED_PAWNS_SCORE_MULTIPLIER = 0.00891602f;
// inline constexpr float PASSED_PAWN_STRUCTURE_SCORE_MULTIPLIER = 0.00891602f;

// inline constexpr float KING_PAWNS_SCORE_MULTIPLIER = 0.018f;
// inline constexpr float KING_ATTACKERS_SCORE_MULTIPLIER = 0.018f;

// inline constexpr float PST_SCORE_MULTIPLIER = 0.022f;

// inline constexpr float MOBILITY_SCORE_MULTIPLIER = 0.227666f;

// inline constexpr float MID_GAME_DEVELOPMENT_SCORE_MULTIPLIER = 0.00633789f;
// inline constexpr float EARLY_GAME_DEVELOPMENT_SCORE_MULTIPLIER = 0.00633789f;

// inline constexpr float ACTIVE_PIECE_MULTIPLIER = 0.0943945f;
// inline constexpr float SPACE_ADVANTAGE_MULTIPLIER = 0.0158398f;

// inline constexpr float SIMPLIFICATION_BONUS_MULTIPLIER = 0.01f;


// Learning result: MSE 0.152977
inline constexpr float DOUBLED_PAWNS_SCORE_MULTIPLIER = 1.44189f;
inline constexpr float ISOLATED_PAWNS_SCORE_MULTIPLIER = 0.307788f;
inline constexpr float SEMI_ISOLATED_PAWNS_SCORE_MULTIPLIER = 0.0f;
inline constexpr float PASSED_PAWN_STRUCTURE_SCORE_MULTIPLIER = 0.180237f;

inline constexpr float KING_PAWNS_SCORE_MULTIPLIER = 0.231421f;
inline constexpr float KING_ATTACKERS_SCORE_MULTIPLIER = 1.17838f;

inline constexpr float PST_SCORE_MULTIPLIER = 1.0f;

inline constexpr float MOBILITY_SCORE_MULTIPLIER = 2.42827f;

inline constexpr float MID_GAME_DEVELOPMENT_SCORE_MULTIPLIER = 0.01f;
inline constexpr float EARLY_GAME_DEVELOPMENT_SCORE_MULTIPLIER = 0.01f;

inline constexpr float ACTIVE_PIECE_MULTIPLIER = 1.12933f;
inline constexpr float SPACE_ADVANTAGE_MULTIPLIER = 0.215625f;

inline constexpr float SIMPLIFICATION_BONUS_MULTIPLIER = 0.01f;



// inline constexpr float DOUBLED_PAWNS_SCORE_MULTIPLIER = 0.0f;
// inline constexpr float ISOLATED_PAWNS_SCORE_MULTIPLIER = 0.0f;
// inline constexpr float SEMI_ISOLATED_PAWNS_SCORE_MULTIPLIER = 0.0f;
// inline constexpr float PASSED_PAWN_STRUCTURE_SCORE_MULTIPLIER = 0.0;

// inline constexpr float KING_PAWNS_SCORE_MULTIPLIER = 0.0;
// inline constexpr float KING_ATTACKERS_SCORE_MULTIPLIER = 0.0;

// inline constexpr float PST_SCORE_MULTIPLIER = 1.0f;

// inline constexpr float MOBILITY_SCORE_MULTIPLIER = 0.0;

// inline constexpr float MID_GAME_DEVELOPMENT_SCORE_MULTIPLIER = 0.0f;
// inline constexpr float EARLY_GAME_DEVELOPMENT_SCORE_MULTIPLIER = 0.0f;

// inline constexpr float ACTIVE_PIECE_MULTIPLIER = 0.0;
// inline constexpr float SPACE_ADVANTAGE_MULTIPLIER = 0.0;

// inline constexpr float SIMPLIFICATION_BONUS_MULTIPLIER = 0.00f;


inline constexpr float PASSED_PAWN_BONUS[8] = {
    0.0f,
    0.0f,
    6.0f,
    32.0f,
...
inline constexpr float MOBILITY_BONUS[6] = {
    4, // KNIGHT
    3, // BISHOP
    2, // ROOK
    1, // QUEEN
...
inline constexpr int64_t SAFETY_TABLE[20] = {
    0, 0, 1, 3, 7, 15, 27, 43, 64, 90, 120, 155, 195, 240, 290, 345, 405, 470, 540, 615
};

inline constexpr float QUEEN_EARLY_DEVELOPMENT_PENALTY = 200.0f;

inline constexpr int64_t ATTACK_WEIGHT[6] = {
    2,  // KNIGHT
    2,  // BISHOP
    3,  // ROOK
    5,  // QUEEN
...
// PeSTO tables - modified by my learning algo
// Source: https://www.chessprogramming.org/PeSTO%27s_Evaluation_Function

inline const int64_t mg_knight_table[64] = {
    -153, -31, -28, -28, -28, -28, -31, -153, 
    -21, -40, -34, -9, -9, -34, -40, -21, 
    -30, -24, -19, -12, -12, -19, -24, -30, 
    -14, 7, -11, -2, -2, -11, 7, -14, 
    6, -11, 10, -3, -3, 10, -11, 6, 
    -9, -12, 15, 19, 19, 15, -12, -9, 
    -18, -64, -9, 4, 4, -9, -64, -18, 
    -106, -35, -43, -34, -34, -43, -35, -106, 
};

inline const int64_t mg_bishop_table[64] = {
    5, 12, -7, -29, -29, -7, 12, 5, 
    9, 11, -1, -2, -2, -1, 11, 9, 
    0, 1, -1, -1, -1, -1, 1, 0, 
    3, -12, -9, 19, 19, -9, -12, 3, 
    -18, 6, -4, 15, 15, -4, 6, -18, 
    3, 14, 36, -12, -12, 36, 14, 3, 
    -16, -19, -23, -29, -29, -23, -19, -16, 
    -33, 52, 19, -24, -24, 19, 52, -33, 
};

inline const int64_t mg_rook_table[64] = {
    -2, 15, 17, 23, 23, 17, 15, -2, 
    -29, 2, 2, -1, -1, 2, 2, -29, 
    -15, -1, -8, -6, -6, -8, -1, -15, 
    -3, 1, -2, 10, 10, -2, 1, -3, 
    10, 16, 25, 41, 41, 25, 16, 10, 
    13, 35, 36, 45, 45, 36, 35, 13, 
    -6, -25, 7, -4, -4, 7, -25, -6, 
    23, 28, 26, 36, 36, 26, 28, 23, 
};

inline const int64_t mg_queen_table[64] = {
    -17, -22, -16, 4, 4, -16, -22, -17, 
    -33, -18, -4, -5, -5, -4, -18, -33, 
    -24, -11, -11, -18, -18, -11, -11, -24, 
    -13, 4, -4, -17, -17, -4, 4, -13, 
    4, -1, -1, -11, -11, -1, -1, 4, 
    6, 8, 22, 3, 3, 22, 8, 6, 
    -5, -57, 3, 1, 1, 3, -57, -5, 
    -18, -8, 31, 31, 31, 31, -8, -18, 
};

inline const int64_t mg_pawn_table[64] = {
    16, -4, -37, -6, -6, -37, -4, 16, 
    -15, -3, -2, -6, -6, -2, -3, -15, 
    -9, 5, -1, 7, 7, -1, 5, -9, 
    -20, -15, -8, -3, -3, -8, -15, -20, 
    -28, -9, -6, 4, 4, -6, -9, -28, 
    -38, -15, 8, -25, -25, 8, -15, -38, 
    -3, -8, -15, -19, -19, -15, -8, -3, 
    -14, -28, 2, 1, 1, 2, -28, -14, 
};

inline const int64_t mg_king_table[64] = {
    -3, 17, -34, -26, -26, -34, 17, -3, 
    1, -2, -47, -34, -34, -47, -2, 1, 
    -26, -10, -10, -9, -9, -10, -10, -26, 
    -16, -6, 18, -10, -10, 18, -6, -16, 
    -3, 2, -1, -48, -48, -1, 2, -3, 
    -61, -8, -11, -52, -52, -11, -8, -61, 
    11, 13, -11, -54, -54, -11, 13, 11, 
    -19, 66, 3, -3, -3, 3, 66, -19, 
};

inline const int64_t eg_knight_table[64] = {
    -150, -37, -20, -31, -31, -20, -37, -150, 
    -33, -48, -37, -26, -26, -37, -48, -33, 
    -41, -24, -33, -14, -14, -33, -24, -41, 
    -18, -4, -2, 13, 13, -2, -4, -18, 
    -3, 3, 9, 15, 15, 9, 3, -3, 
    -11, -16, 3, -1, -1, 3, -16, -11, 
    -23, -48, -22, 5, 5, -22, -48, -23, 
    -129, -24, -33, -36, -36, -33, -24, -129, 
};

inline const int64_t eg_bishop_table[64] = {
    -11, -7, -17, -9, -9, -17, -7, -11, 
    -7, -22, -14, -13, -13, -14, -22, -7, 
    -15, -10, -4, 6, 6, -4, -10, -15, 
    -2, -5, 11, -5, -5, 11, -5, -2, 
    -1, 12, 2, 1, 1, 2, 12, -1, 
    4, 11, -2, -1, -1, -2, 11, 4, 
    12, -3, 1, -7, -7, 1, -3, 12, 
    -27, 23, 14, -10, -10, 14, 23, -27, 
};

inline const int64_t eg_rook_table[64] = {
    -13, 0, 2, -4, -4, 2, 0, -13, 
    -17, -12, -9, -2, -2, -9, -12, -17, 
    -5, 5, 4, -1, -1, 4, 5, -5, 
    9, 18, 22, 25, 25, 22, 18, 9, 
    30, 31, 37, 38, 38, 37, 31, 30, 
    38, 37, 39, 38, 38, 39, 37, 38, 
    -14, -4, -11, -1, -1, -11, -4, -14, 
    44, 32, 35, 34, 34, 35, 32, 44, 
};

inline const int64_t eg_queen_table[64] = {
    -21, -21, -28, -36, -36, -28, -21, -21, 
    -32, -31, -37, -28, -28, -37, -31, -32, 
    -10, -1, -4, -5, -5, -4, -1, -10, 
    -7, 1, 6, 16, 16, 6, 1, -7, 
    1, 3, 11, 17, 17, 11, 3, 1, 
    17, 28, 22, 5, 5, 22, 28, 17, 
    -2, -44, 10, 2, 2, 10, -44, -2, 
    -26, 1, 23, 21, 21, 23, 1, -26, 
};

inline const int64_t eg_pawn_table[64] = {
    17, -13, -24, -1, -1, -24, -13, 17, 
    30, 43, 44, 29, 29, 44, 43, 30, 
    31, 38, 31, 35, 35, 31, 38, 31, 
    30, 32, 20, 15, 15, 20, 32, 30, 
    28, 30, 13, -2, -2, 13, 30, 28, 
    11, 1, -10, -40, -40, -10, 1, 11, 
    -1, -12, -14, -25, -25, -14, -12, -1, 
    -13, -13, -3, 2, 2, -3, -13, -13, 
};

inline const int64_t eg_king_table[64] = {
    -84, -51, -36, -66, -66, -36, -51, -84, 
    -44, -31, -14, -20, -20, -14, -31, -44, 
    -35, -17, -5, 8, 8, -5, -17, -35, 
    -35, -2, 4, 23, 23, 4, -2, -35, 
    -11, 11, 19, 16, 16, 19, 11, -11, 
    -38, 0, 2, -27, -27, 2, 0, -38, 
    4, 21, -2, -55, -55, -2, 21, 4, 
    -7, 52, -1, -19, -19, -1, 52, -7, 
};
...
inline const int64_t *PST_TABLE[2][6] = {
    // MID GAME
    {
        mg_knight_table, // KNIGHT
        mg_bishop_table, // BISHOP
        mg_rook_table, // ROOK
        mg_queen_table, // QUEEN 
        mg_pawn_table, // PAWN
        mg_king_table // KING
    }, 
    // END GAME
...
inline const int64_t gamephase_inc[6] = {
    1, // KNIGHT
    1, // BISHOP
    2, // ROOK
    4, // QUEEN
...
inline constexpr int64_t pst_mg_value[6] = { 
    337, // KNIGHT
    365, // BISHOP
    477, // ROOK
    1025,  // QUEEN
...
inline constexpr int64_t pst_eg_value[6] = { 
    281, // KNIGHT
    297, // BISHOP
    512, // ROOK
    936, // QUEEN
...
const uint64_t Polyglot_Random64[781] = {
